...
_SECURITY_SYSTEM_PROMPT = """You are VlamGuard AI, an infrastructure security analyst. You receive Kubernetes manifest metadata, policy check results, and security scan findings. Respond with a JSON object containing:
